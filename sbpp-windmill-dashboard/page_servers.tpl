            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    {foreach from=$server_list item=server}
                        <tr class="text-gray-700 dark:text-gray-400 opener" id="opener_{$server.sid}"
                            style="cursor:pointer;" {if !$IN_SERVERS_PAGE} onclick="{$server.evOnClick}" {/if}>
                                    ...
                                    <div class="opener">
                                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                                            ...
                                            <div id="serverwindow_{$server.sid}">
                                                ...
                                                <div id="noplayer_{$server.sid}" name="noplayer_{$server.sid}"
