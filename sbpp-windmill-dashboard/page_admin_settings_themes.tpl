        ...
        <div class="w-full">
            ...
            <div class="current-theme-holder mx-auto mt-11 w-80 transform overflow-hidden">
                ...
                <div id="current-theme-details" class="p-4 text-gray-700 dark:text-gray-400">
                    ...
                    <p>
                        <span class="font-semibold">Theme Link:</span> <span id="theme.link"><a
                                href="{$theme_link}">{$theme_link}</a></span>
                    </p>
                </div>
            </div>

            <div
                class="p-2 mt-2 space-y-2 text-gray-600 bg-white border border-gray-100 rounded-md shadow-md dark:text-gray-300 dark:border-gray-700 dark:bg-gray-700">
