                    ...
                    <table width="100%" cellpadding="0" class="listtable" cellspacing="0">
                        <tr>
                            ...
                            <td width="66%"><input
                                    ...
                                    type="text" id="nick" value="" onmouseup="$('name').checked = true"></td>
                        </tr>
                        <tr>
                            ...
                            <td class="flex items-center">
                                ...
                                <select
                                    ...
                                    id="steam_match" onmouseup="$('steam_').checked = true">
                        ...
                        <tr>
                            ...
                            <td class="listtable_1"><input
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    type="text" id="ban_reason" value="" onmouseup="$('reason_').checked = true"></td>
                        </tr>
                        <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                            <input
                                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                                type="text" id="other_length" name="other_length"
                                                onmouseup="$('length_').checked = true" style="display:none;">
                                        </td>
                                        <td>
                                            <select
                                                class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                        ...
                        <tr>
                            ...
                            <td class="listtable_1">
                                <select
                                    class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                                    id="ban_type" onmouseup="$('ban_type_').checked = true">
                        ...
                        {if !$hideadminname}
                            <tr>
                                ...
                                <td class="listtable_1">
                                    <select
                                        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                                        id="ban_admin" onmouseup="$('admin').checked = true">
                        ...
                        <tr>
                            ...
                            <td class="listtable_1">
                                <select
                                    class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                                    id="server" onmouseup="$('where_banned').checked = true">
