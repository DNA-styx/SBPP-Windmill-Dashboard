            ...
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                If you are unsure on how to record evidence within in-game, please <a class="font-semibold" href="#" @click="openModal">click here</a> for an explanation.
            </p>
    ...
    <form action="index.php?p=submit" method="post" enctype="multipart/form-data">
        ...
        <table>
            <tr>
                <td>
                <span class="text-gray-700 dark:text-gray-400">Player's SteamID:</span></td>
                <td>
                    <input
            ...
            <tr>
                <td>
                <span class="text-gray-700 dark:text-gray-400">Player's IP:</span></td>
                <td>
                <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
            ...
            <tr>
                <td>
                <span class="text-gray-700 dark:text-gray-400">Player's Nickname *</span></td>
                <td>
                <input
                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
